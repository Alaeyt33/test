	...
	collector.on('end', async (msgs, reason) => {
		if (reason == 'DONE') {
			const embed = new Discord.MessageEmbed()
				.setTitle('Situation Roles!')
				.setDescription('Click on the buttons to grant yourself a role!')
        .setImage('https://cdn.discordapp.com/attachments/1138936835217825802/1195800112627200100/Discover_Gaming_3.gif?ex=65b54ea3&is=65a2d9a3&hm=754f95a50093fe7854d420175cbe330e4fd049e6153a9740884b88ffe80ee7e1&')
				.setColor('45178D')
				.setTimestamp()
