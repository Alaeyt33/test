...
module.exports.run = async (client, message, args) => {
	...
	collector.on('end', async (msgs, reason) => {
        ...
        .setImage('https://cdn.discordapp.com/attachments/1138936835217825802/1195800113461874788/Discover_Gaming.gif?ex=65b54ea3&is=65a2d9a3&hm=b54aaf11b4ac697feb50b0a51f1f4495cd1b844f7fecd6f8828d267bdccff4b0&')
				.setColor('45178D')
				.setTimestamp()
